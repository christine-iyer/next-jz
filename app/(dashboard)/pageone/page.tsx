...
  Red semicircle
  <path d="M 50,100 A 50,50 0 0,1 150,100 L 150,100 Z" fill="#D22B2B" />
  
  Yellow circle
  <circle cx="90" cy="83" r="12" fill="#FDDA0D" />
  
  Yellow stem
  <rect x="95" y="100" width="10" height="50" fill="#FDDA0D" />
  
  Yellow base
  <rect x="80" y="150" width="40" height="10" fill="#FDDA0D" />
</svg>

#2
<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200">
   Red semicircle (flipped) 
  <path d="M 50,100 A 50,50 0 0,0 150,100 L 150,100 Z" fill="#D22B2B" />
  
   Yellow circle 
  <circle cx="100" cy="83" r="12" fill="#FDDA0D" />
...
#3
<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200">
   Red semicircle (flat side on top, centered over stem) 
  <path d="M 75,100 A 50,50 0 0,0 125,100 L 125,100 Z" fill="#D22B2B" />
  
   Yellow circle 
  <circle cx="100" cy="85" r="15" fill="#FDDA0D" />
